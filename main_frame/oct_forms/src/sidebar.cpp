...
void Sidebar::loadSettingsFromSettings(CCSystemSettings *settingsManager, bool isFromFile)
{
    this->disconnectGuiElementsFromAutosave();
    this->recordSettings = settingsManager->getStoredSettings(REC);
    if(isFromFile){
...
void Sidebar::updateLoadSettings()
{
    //Recording
...
void Sidebar::updateCalculateParams()
{
    OctAlgorithmParameters* params = OctAlgorithmParameters::getInstanceForDebug();
    params->depthCompensation = this->ui.depthCompensationSpinbox->value();
}
