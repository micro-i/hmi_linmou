...
unix{
	...
	exists($$shell_path($$CUDA_DIR/samples)){
		NVCUDASAMPLES_ROOT = $$shell_path($$CUDA_DIR/samples)
                ...
                NVCUDASAMPLES_ROOT = $$shell_path($$PWD)
	}
}
win32{
	CUDA_DIR = $$(CUDA_PATH)
	...
	isEmpty(NVCUDASAMPLES_ROOT){
                NVCUDASAMPLES_ROOT = $$shell_path($$PWD) #in older CUDA versions NVCUDASAMPLES_ROOT is defined. it is the location of the CUDA samples folder
	}
